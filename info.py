...
PICS = (environ.get('PICS', 'https://i.ibb.co/DPngQS9L/photo-2026-01-16-00-02-20.jpg')).split()
...
# Safety limit for /getall commands
GETALL_LIMIT = int(environ.get('GETALL_LIMIT', '500'))
